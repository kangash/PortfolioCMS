                ...
                <form id="settingForm">
                    ...
                    <?php if($setting->key_field == 'Language'): ?>
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <select class="form-control" name="<?= $setting->key_field ?>" value="<?= $setting->value ?>" id="formLangSite">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                        <input class="form-control" type="text" name="<?= $setting->key_field ?>" value="<?= $setting->value ?>" id="formLangSite">
                        </div>
                    </div>
                    <?php endif; ?>
                <?php endforeach; ?>
